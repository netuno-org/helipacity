...
function Content({
  ...
  if (type === "text") {
    ...
    layout = (
      <div className={section + "__text"}>
        <div className="text">
          <h1
            className="text__title__events text__title--stroke"
            dangerouslySetInnerHTML={{ __html: titleStyled }}
          ></h1>
          <h1
            className="text__title__events "
            dangerouslySetInnerHTML={{ __html: titleStyled }}
          ></h1>
          <h1
            className="text__title__events text__title--stroke "
        ...
        <div className="text__eventsSelect">
  ...
  } else if (type === "basedivider") {
    // divisória amarela entre as páginas
    return (
      <div>
        <BaseDivider />
      </div>
